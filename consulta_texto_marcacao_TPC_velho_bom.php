...
inserir_em_dic2me_controlo_id_do_tpc_mostrar_miudos_id_do_TPC 60 

gerir_dic2me_controlo_id_do_tpc_mostrar_miudos

inserir_em_dic2me_controlo_id_do_tpc_mostrar_miudos_id_do_TPC 60

gerir_dic2me_controlo_id_do_tpc_mostrar_miudos esteaqui  1139

funcoes_de_obter_queris 803
...
echo "UDETOS";
	...
	#da tabela dic2me_controlo_id_do_tpc_mostrar_miudos exit
	echo "MARE";
	$id_a_mostrar_alunos_do_tpcBD=obter_id_da_tabela_dic2me_controlo_id_do_tpc_mostrar_miudos ($controlo);
	echo "POIZXCD";

	##inserir valores para controlo do id do TPC a mostrar aos alunos no caso de tpc para toda a turma tirar
	$id_do_TPC_para_miudos=gerir_dic2me_controlo_id_do_tpc_mostrar_miudos($controlo, $id_linha);
	echo "LUAD";
...
#098098098098
	#da tabela dic2me_controlo_id_do_tpc_mostrar_miudos
#devemos proteger em primeiro a garantia de que não estamos a remarcar o mesmo TCP, e logo de seguida se esse id já foi ou não marcado PARA o MESMO PROFESSOR 99
	echo "MERDAFG FIMZ ";
...
#vamos vlidar se o  $id_do_TPC_para_miudos , garantir em 1 que esse id não foi ainda gerado

			 $quantos=garante_obter_unico_obter_id_da_tabela_dic2me_controlo_id_do_tpc_mostrar_miudos($controlo,$id_do_TPC_para_miudos);
			 echo "FODER";
#limpar############# $proteger_marcacao_do_mesmo_ditado=proteger_marcacao_do_mesmo_ditado($controlo, $id_texto, $id_do_tpc_dados_alunos);
			echo "PUTASconasrabo";
