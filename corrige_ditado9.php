...
$naoinserirmais="NAO";
 ...
 #######################
 #validaa se chamada é todos os ditados ou so um ditado de um aluno
 #####################################################################
 
 #http://qa01.dic2me.com/dic2me/corrige_ditado9.php?CONTROLO=1518383929&codigoTPC=1788446979
 
 $controlo=$_GET['CONTROLO'];
$codigoTPC=$_GET['codigoTPC'];

$ERROS=protege_contaerrosdoalunos($idTPC);

#$resultado=contapalavrasescritasparavalidarditado($codigoTPC);
if ($ERROS == 0)
{

MANUAL_geral_detetaerros($controlo,$codigoTPC);
}
else
{
echo "  ";
...
#}
		...
		#echo "echo grande erro em texto)";
	#}	
...
<?php if ($errosortograficos>0)
{
	...
	<img src="images/sad.png" width="300" height="166">
<?php }
else{
	?>
	<img src="images/happy.png" width="300" height="166">
<?php } 
?>
...
<div id="Paris" class="tabcontent">
 ...
 <?php mostrar_codigos_de_erros_do_ditado_a_professora(); ?>
   <br>
  <p>
  <a href="http://vmi100391.contabo.host/dic2me/imprime_outros_erros_nao_ortograficos.php?id=<?php echo $codigoTPC ?>" title="imprimirtexto" target="new">imprimir <img src="imagens/impressora.jpg" width="130" height="88"></a>
...
echo $ditadofeito_aluno;
?><br><?php

	$nif_aluno=obter_id_cookie_aluno(); ?>  
			<?php $ID_DITADO=$_POST['id_doTPC']; 
            $mensagem ="http://vmi100391.contabo.host/dic2me/imprime_ditado_escrito_por_aluno.php?" . "&idditado=" . $ID_DITADO . "&NIF=" . $nif_aluno;  
			mostra($mensagem);
			mostra(QUERYCIMA);
            ?>
            <a href= <?php echo $mensagem ?> title="imprimirtexto" target="new">imprimirnovo <img src="imagens/impressora.jpg" width="130" height="88"></a>
           <?php $mensagem ?> title="imprimirtexto" target="new">imprimirvelho <img src="imagens/impressora.jpg" width="130" height="88"></a>
		<?php
